...
export class InsertReservationService 
{
 ...
 return new Promise((resolve) => {
        this.http.post('http://hainedefirmasj.com/placesforme//insert_reservations_sendData.php',JSON.stringify(postParams),options).map(result => result.json()).subscribe(data => {
