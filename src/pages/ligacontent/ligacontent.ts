...
/**
 * Generated class for the Ligacontent page.
 *
...
@IonicPage()
@Component({
  selector: 'page-ligacontent',
  templateUrl: 'ligacontent.html',
})
export class Ligacontent {
 public title: string[] = [];
  ...
  constructor(public navCtrl: NavController,
              public navParams: NavParams) {
                this.title = ['LIGA ', 'LIGA' ,'LIGA ', 'LIGA'];
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Ligacontent');
  }
