...
declare var google;
/**
 * Generated class for the Googleregister page.
 *
...
@IonicPage()
@Component({
  selector: 'page-googleregister',
  templateUrl: 'googleregister.html',
})
export class Googleregister {
  ...
  //  this.diagnostic.isGpsLocationEnabled().then(successCallback, errorCallback);
    ...
    public googlePopUp(place) {
        let popover = this.popoverCtrl.create('Googlepopover',{ place:place, register:true });
        popover.present();
    }
